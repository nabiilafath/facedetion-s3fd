...
Original file is located at
    https://colab.research.google.com/drive/1rWzr6ydK3sg0b7VpXzpmucxEfpt9SP49
"""
...
img = plt.imread('/content/drive/MyDrive/PCDML/test.JPG')
...
# loading image
img = plt.imread('/content/drive/MyDrive/PCDML/rame.JPG')
img = resize_with_pad(img)
...
# loading image
img = plt.imread('/content/drive/MyDrive/PCDML/6.jpg')
img = resize_with_pad(img)
